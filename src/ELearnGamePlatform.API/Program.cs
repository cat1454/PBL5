...
builder.Services.AddScoped<IExternalDocumentParser, DoclingDocumentParser>();
...
builder.Services.AddScoped<IClassroomAnalyticsService, ClassroomAnalyticsService>();
